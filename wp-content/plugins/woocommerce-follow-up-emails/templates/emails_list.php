                    ...
                    <tr scope="row">
                        <td class="post-title column-title">
                            ...
                            <div class="row-actions">
                                ...
                                |
                                <span class="trash"><a onclick="return confirm('Really delete this email?');" href="admin.php?page=followup-emails&tab=delete&id=<?php echo $email->id; ?>"><?php _e('Delete', 'follow_up_emails'); ?></a></span>
                            </div>
                        </td>
                        <td>
