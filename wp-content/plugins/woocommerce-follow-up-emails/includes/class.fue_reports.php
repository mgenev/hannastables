...
class FUE_Reports {
    ...
    public function settings_tab($tab = '') {
        ...
        echo '<a href="admin.php?page=followup-emails-reports&amp;tab=reports" class="nav-tab '. $class .'">'. __('Reporting', 'follow_up_emails') .'</a>';
    }
    ...
    static function reports_html() {
        ...
        include FUE_TEMPLATES_DIR .'/reports_overview.php';
        return;
        ...
        <table class="wp-list-table widefat fixed posts">
            <thead>
                <tr>
                    ...
                    <th scope="col" id="user_email" class="manage-column column-user_email" style="">'. __('Email', 'follow_up_emails') .'</th>
    ...
    public static function email_open_html($id, $name) {
        ...
        if (empty($reports)) {
            ...
            foreach ($reports as $report) {
                ...
                //$clicked = ( $count_clicked > 0 ) ? __('Yes', 'follow_up_emails') : __('No', 'follow_up_emails');
        ...
        <table class="wp-list-table widefat fixed posts">
            <thead>
                <tr>
                    <th scope="col" id="user_email" class="manage-column column-user_email" style="">'. __('Email', 'follow_up_emails') .'</th>
                    <th scope="col" id="date_sent" class="manage-column column-date_sent" style="">'. __('Date Opened', 'follow_up_emails') .'</th>
                </tr>
            </thead>
            <tbody id="the_list">
                '. $block .'
    ...
    public static function link_click_html($id, $name) {
        ...
        if (empty($reports)) {
            $block = '
            <tr scope="row">
                <th colspan="3">'. __('No reports available', 'follow_up_emails') .'</th>
            </tr>';
        } else {
            foreach ($reports as $report) {
                $block .= '
        ...
        <table class="wp-list-table widefat fixed posts">
            <thead>
                <tr>
                    <th scope="col" id="user_email" class="manage-column column-user_email" style="">'. __('Email', 'follow_up_emails') .'</th>
                    <th scope="col" id="user_email" class="manage-column column-user_email" style="">'. __('Target URL', 'follow_up_emails') .'</th>
                    <th scope="col" id="date_sent" class="manage-column column-date_sent" style="">'. __('Date Clicked', 'follow_up_emails') .'</th>
                </tr>
            </thead>
            <tbody id="the_list">
                '. $block .'
