	...
	<div id="footer">
		...
		<div class="secondary clearfix">	
			...
			<div class="right"><p><?php if($footer_right){echo($footer_right);} else{ ?><a href="http://www.hannastables.com/cancellation-policy/" title="Hanna Stables cancellation policy"> Terms of Agreement </a>| Website and Photos by <a href="http://www.geminiconnect.com" title="Gemini Connect Digital Marketing"><strong>Gemini Connect</strong></a><?php }; ?></p></div>
